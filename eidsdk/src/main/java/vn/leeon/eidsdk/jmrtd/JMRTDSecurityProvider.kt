...
class JMRTDSecurityProvider private constructor() : Provider("JMRTD", 0.1, "JMRTD Security Provider") {
    ...
    init {
        ...
        put("CertStore.JKS", "vn.leeon.eidsdk.jmrtd.cert.KeyStoreCertStoreSpi")
        put("CertStore.BKS", "vn.leeon.eidsdk.jmrtd.cert.KeyStoreCertStoreSpi")
        put("CertStore.PKCS12", "vn.leeon.eidsdk.jmrtd.cert.KeyStoreCertStoreSpi")
