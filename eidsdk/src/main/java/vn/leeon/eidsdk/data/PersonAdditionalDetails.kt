...
class PersonAdditionalDetails : Parcelable {
    ...
    companion object {
        @JvmField
        val CREATOR: Parcelable.Creator<*> = object : Parcelable.Creator<PersonAdditionalDetails> {
            override fun createFromParcel(pc: Parcel): PersonAdditionalDetails {
                return PersonAdditionalDetails(pc)
            }

            override fun newArray(size: Int): Array<PersonAdditionalDetails?> {
